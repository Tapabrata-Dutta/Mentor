...
commercialpi = Degree("Commercial Pilot", "200 hr", Difficulty.Medium)
...
teacher = Career("Teacher", Demand.Medium, bEd, 5)
professor = Career("Professor", Demand.Medium, pHd, 8)
...
contentCreater = Career("Content Creater", Demand.Medium, anyD, 4)
model = Career("Model", Demand.Medium, anyD, 4)
sportPerson = Career("Sports Person", Demand.Medium, anyD, 4)
publicService = Career("Public Service", Demand.High, uPSC, 10)
librarian = Career("Librarian", Demand.Medium, anyD, 6)
digitalMarketing = Career("Digital Marketing", Demand.Medium, anyD, 6)
commercialPilot = Career("Commercial Pilot", Demand.High,commercialpi, 8)
customOfficial = Career("Custom Official", Demand.Medium, sSC, 5)
policeOfficer = Career("Police Officer", Demand.Medium, sSC, 5)
army = Career("Army Officer", Demand.Medium, nDA, 5)
...
iAS = Career("IAS Officer", Demand.High, uPSC, 14)
iPS = Career("IPS Officer", Demand.High, uPSC, 14)
